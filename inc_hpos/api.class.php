...
class POSTIS_API {
    ...
    */
    function create_shipment_api_request($order_id, $bulk_shipment, $postmeta = array()){
        ...
        $shipping_service        = $order->get_meta( 'postis_shipping_method' );
        ...
        if ($shipping_service == 'DPO') {
            ...
            $postbox_id            = $order->get_meta( 'postis_dpo_postbox' );
            $postbox_phonenumber   = $order->get_meta( 'postis_dpo_phonenumber' );
            ...
            $parcelpoints_name            = $order->get_meta( 'postis_dpt_parcelpoints' );
            $postbox_phonenumber          = $order->get_meta( 'postis_dpt_phonenumber' );
    ...
    */
    function print_shipment_api_request($shipmentId){
        ...
        error_log('Print command sent to API');
