...
$shipping_method_custom_meta = get_post_meta( $order_id, 'postis_shipping_method', true );
...
$parcelpoint_name = get_post_meta($order_id, 'postis_dpt_parcelpoints', true);
$phone_number = get_post_meta($order_id, 'postis_dpo_phonenumber', true);
...
// Check if shipmentis international
        ...
        <div class="postis-international-options-section">
            ...
            <div class="postis-inter-contents-options">
                ...
                foreach ( $wc_order->get_items() as $item_id => $item ) {
                    ...
                    $item_tnumber      = get_post_meta($product_id, 'hsTariffNumber', true );
                    $item_desc_content = get_post_meta($product_id, 'descriptionOfContents', true );
                ?>
